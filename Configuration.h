...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 186.1 // mm
  ...
  //#define DELTA_ENDSTOP_ADJ { 30, 30, 30 }
...
#define MANUAL_Z_HOME_POS 291.25 // Distance between the nozzle to printbed after homing
