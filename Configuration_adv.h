...
// Add support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENT_CHANGE_FEATURE             // Enable filament exchange menu and M600 g-code (used for runout sensor too)
    ...
    #define FILAMENT_CHANGE_Y_POS 30             // Y position of hotend
    #define FILAMENT_CHANGE_Z_ADD 30            // Z addition of hotend (lift)
    #define FILAMENT_CHANGE_XY_FEEDRATE 50     // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
    #define FILAMENT_CHANGE_Z_FEEDRATE 50        // Z axis feedrate in mm/s (not used for delta printers)
